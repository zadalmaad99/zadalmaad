...
export default function ReportModal({ record, studentName, onClose }) {
  ...
  const totalAyahs = last ? last.ayahTo : 0;
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <h3>
            تقرير التقدم — {studentName} — {record.surahNumber}. {record.surahName}
          </h3>
        ...
        <div className="report-summary">
          ...
          <div className="report-stat">
            <span className="report-stat-value">{totalAyahs}</span>
            <span className="report-stat-label">آية محفوظة</span>
          </div>
          <div className="report-stat">
        ...
        <ol className="report-timeline">
          {history.map((h, i) => {
            ...
            const gained = prev ? h.ayahTo - prev.ayahTo : h.ayahTo - h.ayahFrom + 1;
            return (
              <li key={i} className="report-item">
                ...
                <div className="report-item-body">
                  ...
                  <div className="report-item-range">
                    من آية {h.ayahFrom} إلى آية {h.ayahTo}
                    {gained > 0 && (
                      <span className="report-item-gain"> (+{gained} آية)</span>
                    )}
                  </div>
                </div>
              </li>
